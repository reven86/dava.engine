...
LOCAL_SRC_FILES := \
	...
	$(wildcard $(MY_PROJECT_ROOT)/Classes/SFML/*.cpp) \
	$(wildcard $(MY_PROJECT_ROOT)/Classes/SFML/Network/*.cpp) \
	$(wildcard $(MY_PROJECT_ROOT)/Classes/SFML/Network/Unix/*.cpp) \
	$(wildcard $(MY_PROJECT_ROOT)/Classes/SFML/System/*.cpp) \
