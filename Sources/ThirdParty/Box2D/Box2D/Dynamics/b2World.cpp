...
void b2World::Step(b2_float32 dt, b2_int32 velocityIterations, b2_int32 positionIterations)
{
...
{
	b2_float32 RayCastCallback(const b2RayCastInput& input, b2_int32 proxyId)
	{
		...
		if (hit)
		{
			b2_float32 fraction = output.fraction;
	...
	case b2Shape::e_polygon:
		{
			...
			b2_int32 vertexCount = poly->m_vertexCount;
...
void b2World::DrawDebugData()
{
	...
	b2_uint32 flags = m_debugDraw->GetFlags();
