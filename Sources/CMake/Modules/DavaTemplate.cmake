...
if( WIN32 )
    ...
    list ( APPEND ADDITIONAL_DLL_FILES ${DINAMIC_LIBRARIES_${DAVA_PLATFORM_CURENT}} )
elseif( MACOS )
    ...
    list ( APPEND MACOS_DYLIB  ${DINAMIC_LIBRARIES_${DAVA_PLATFORM_CURENT}} )
endif()
...
target_link_libraries( ${PROJECT_NAME} ${LINK_WHOLE_ARCHIVE_FLAG} ${TARGET_LIBRARIES} ${NO_LINK_WHOLE_ARCHIVE_FLAG} ${LIBRARIES} ${STATIC_LIBRARIES_${DAVA_PLATFORM_CURENT}} )
