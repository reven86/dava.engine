...
{
    return AddChild(parent, name, content.c_str());
} /**< See above. */
inline xmlNode* AddChild(xmlNode* parent, const char* name, FUSStringBuilder& content)
{
    return AddChild(parent, name, content.ToCharPtr());
} /**< See above. */
...
inline void AddContentUnprocessed(xmlNode* node, const fm::string& content)
{
    return AddContentUnprocessed(node, content.c_str());
} /**< See above. */
inline void AddContentUnprocessed(xmlNode* node, FUSStringBuilder& content)
{
    return AddContentUnprocessed(node, content.ToCharPtr());
} /**< See above. */
...
/** Creates a child XML tree node within a XML tree node.
		...
		@return The new child XML tree node. */
template <typename T>
inline xmlNode* AddChild(xmlNode* parent, const char* name, const T& value)
{
    xmlNode* child = AddChild(parent, name);
    FUSStringBuilder builder;
    builder.set(value);
    AddContentUnprocessed(child, builder.ToCharPtr());
    return child;
}
...
inline xmlNode* AddChildOnce(xmlNode* parent, const char* name, const fm::string& content)
{
    return AddChildOnce(parent, name, content.c_str());
} /**< See above. */
inline xmlNode* AddChildOnce(xmlNode* parent, const char* name, FUSStringBuilder& content)
{
    return AddChildOnce(parent, name, content.ToCharPtr());
} /**< See above. */
...
/** Returns a child XML tree node within a XML tree node.
		...
		@return The child XML tree node. */
template <typename T>
inline xmlNode* AddChildOnce(xmlNode* parent, const char* name, const T& value)
{
    xmlNode* child = AddChildOnce(parent, name);
    FUSStringBuilder builder(value);
    AddContentUnprocessed(child, builder.ToCharPtr());
    return child;
}
...
{
    AddContent(node, content.c_str());
} /**< See above. */
inline void AddContent(xmlNode* node, FUSStringBuilder& content)
{
    AddContent(node, content.ToCharPtr());
} /**< See above. */
...
template <typename T>
inline void AddContent(xmlNode* node, const T& value)
{
    FUSStringBuilder builder(value);
    return AddContentUnprocessed(node, builder.ToCharPtr());
}
...
{
    AddAttribute(node, attributeName, attributeValue.ToCharPtr());
} /**< See above. */
inline void AddAttribute(xmlNode* node, const char* attributeName, const fm::string& attributeValue)
{
    AddAttribute(node, attributeName, attributeValue.c_str());
} /**< See above. */
...
template <typename T>
inline void AddAttribute(xmlNode* node, const char* attributeName, const T& attributeValue)
{
    FUSStringBuilder builder;
    builder.set(attributeValue);
    AddAttribute(node, attributeName, builder.ToCharPtr());
}
