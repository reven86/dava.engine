...
struct b2RevoluteJointDef : public b2JointDef
{
	...
	b2_float32 lowerAngle;

	/// The upper angle for the joint limit (radians).
	b2_float32 upperAngle;
...
public:
	...
	b2_float32 GetJointAngle() const;
...
protected:
	...
	bool m_enableLimit;
	b2_float32 m_referenceAngle;
	b2_float32 m_lowerAngle;
	b2_float32 m_upperAngle;
	...
	b2_float32 m_motorMass;	// effective mass for motor/limit angular constraint.
	b2LimitState m_limitState;
};

inline b2_float32 b2RevoluteJoint::GetMotorSpeed() const
{
	return m_motorSpeed;
}
